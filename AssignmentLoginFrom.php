...
if (isset($_POST['login'])) {
    ...
    if ($email == "antor@gmail.com" && $pass == "123456") {
    ...
    }elseif(!filter_var($pass,FILTER_VALIDATE_INT)){
        $errPass= "<span style='color: red'>The password that you've entered is incorrect. Forgotten password?</span>";
    }
                   ...
                   <h2 class="bg-primary text-light mb-4 p-2 border rounded ">LOGIN FORM</h2>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            value="<?= $pass ?? null ?>"
                            class="form-control <?= isset($errPass) ? 'is-invalid':null ?>">
                            <?= $errPass ?? null ?>
                        </div>
